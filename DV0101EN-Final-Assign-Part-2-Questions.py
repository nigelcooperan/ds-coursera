...
app.layout = html.Div([
    ...
    html.Div(dcc.Dropdown(
            id='select-year',
            #pass a list of years 'year_list' as options in this dropdowwn
            #year_list = [i for i in range(1980, 2024, 1)],
...
def update_output_container(selected_statistics, input_year):
   ...
   # elif dropdown-statistics == 'Yearly Statistics':
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
         # grouping data for plotting.
         # Hint:Use the columns Year and Automobile_Sales
        avr_vdata=yearly_data.groupby('Year')['Automobile_Sales']avg().reset_index()
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(data = exp_data, names = 'Vehicle_Type', values = 'Advertising_Expenditure', title = 'Total Advertisment Expenditure for Each Vehicle'))
